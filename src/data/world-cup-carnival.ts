...
export const LUCKY_BOX_TIERS: LuckyBoxTier[] = [
  {
    ...
    accent: "accent",
    prizes: [
      { label: "2 U Position Voucher", chance: 0.35 },
      { label: "10 U Position Voucher", chance: 0.18 },
      { label: "20 U Position Voucher", chance: 0.07 },
      { label: "1 U Cash", chance: 0.25 },
      { label: "2 U Cash", chance: 0.1 },
      { label: "5 U Cash", chance: 0.05 },
    ],
  },
  {
    id: "premium",
    ...
    accent: "amber",
    prizes: [
      { label: "20 U Position Voucher", chance: 0.28 },
      { label: "50 U Position Voucher", chance: 0.16 },
      { label: "100 U Position Voucher", chance: 0.06 },
      { label: "5 U Cash", chance: 0.25 },
      { label: "10 U Cash", chance: 0.15 },
      { label: "20 U Cash", chance: 0.08 },
      { label: "World Cup Jersey", chance: 0.02, hero: true },
    ],
  },
  {
    id: "grand",
    ...
    accent: "blue",
    prizes: [
      { label: "100 U Position Voucher", chance: 0.26 },
      { label: "200 U Position Voucher", chance: 0.14 },
      { label: "500 U Position Voucher", chance: 0.05 },
      { label: "10 U Cash", chance: 0.25 },
      { label: "50 U Cash", chance: 0.16 },
      { label: "100 U Cash", chance: 0.08 },
      { label: "World Cup Jersey", chance: 0.05, hero: true },
      { label: "Signed World Cup Jersey", chance: 0.01, hero: true },
    ],
  },
];
