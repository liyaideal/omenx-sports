...
export const LIVE_TRADES: LiveTrade[] = [
  {
    ...
    outcomeLabel: "USA",
    price: 48,
    eventTitle: "United States vs Paraguay",
    eventTeams: ["usa", "paraguay"],
    league: "WC",
    secondsAgo: 8,
  ...
  },
  {
    ...
    outcomeLabel: "Canada",
    price: 28,
    eventTitle: "Canada vs Bosnia-Herzegovina",
    eventTeams: ["canada", "bosnia"],
    league: "WC",
    secondsAgo: 96,
    tradeHref: omenxUrl.markets(),
  },
  {
    ...
    hue: 215,
    side: "sold",
    outcomeLabel: "Korea Republic",
    price: 37,
    eventTitle: "Korea Republic vs Czechia",
    eventTeams: ["koreaRep", "czechia"],
    league: "WC",
    secondsAgo: 142,
    tradeHref: omenxUrl.markets(),
  },
  {
    ...
    outcomeLabel: "Yes",
    price: 97,
    eventTitle: "Messi plays at the World Cup",
    eventTeams: ["usa"],
    league: "WC",
    secondsAgo: 188,
    tradeHref: omenxUrl.markets(),
  },
  {
    ...
    hue: 230,
    side: "bought",
    outcomeLabel: "Bosnia-Herzegovina",
    price: 22,
    eventTitle: "Canada vs Bosnia-Herzegovina",
    eventTeams: ["canada", "bosnia"],
    league: "WC",
