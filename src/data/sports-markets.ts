...
export const MATCH_MARKETS: SportsMarket[] = [
  ...
  // ----- FIFA World Cup 2026 — group-stage 1X2 markets -----
  {
    id: "wc26-mex-rsa",
    kind: "match",
    shape: "three-way",
  ...
  },
  {
    ...
    outcomes: [
      ...
      { id: "a", label: "CZE", price: 0.35, delta24h: -0.01, team: TEAMS.czechia },
    ],
