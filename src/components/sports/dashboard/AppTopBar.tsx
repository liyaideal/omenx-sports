        ...
        <div className="flex min-w-0 items-center gap-4 xl:gap-8">
          ...
          <nav className="flex min-w-0 items-center gap-1">
            <Link
              to="/promo/world-cup"
              search={{ tab: "overview" }}
              className="group relative flex items-center gap-1.5 overflow-hidden rounded-lg border border-[oklch(0.7_0.18_145)]/40 bg-[oklch(0.7_0.18_145)]/10 px-3 py-2 font-pitch text-xs font-bold uppercase tracking-[0.18em] text-[oklch(0.7_0.18_145)] transition-all hover:bg-[oklch(0.7_0.18_145)]/20 hover:text-white xl:px-3.5"
              style={{
                boxShadow:
