              ...
              >
                <div className="min-w-0">
                  <div className="flex items-center gap-2 min-w-0">
                    {m.subjectTeam && (
                      <span
                        className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-white/[0.05] p-[2px]"
                        style={{
                          boxShadow: `0 0 10px -3px oklch(0.7 0.22 ${m.subjectTeam.hue} / 0.55)`,
                        }}
                      >
                        <img
                          src={m.subjectTeam.logo}
                          alt=""
