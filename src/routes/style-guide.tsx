            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-dashed border-white/15 bg-white/[0.02] p-5 text-xs">
                ...
                <ul className="space-y-1.5 text-muted-foreground">
                  ...
                  <li>• <b>Post-submit ticket reveal</b>: after a combo is accepted, <code className="font-mono text-foreground">TicketAcceptedModal</code> shows a secondary "View my ticket" button. Closing the modal by any path (View, Build another, click-outside, Esc) auto-smooth-scrolls to the <code className="font-mono text-foreground">#combo-my-tickets</code> section and applies a 2.5s amber ring + glow + pulse to the newest <code className="font-mono text-foreground">TicketRow</code>. Same behavior on desktop and mobile. Respects <code className="font-mono text-foreground">prefers-reduced-motion</code> (instant scroll, ring still applied). Prevents users from getting lost on the long page and not realizing their ticket landed at the bottom.</li>
                </ul>
              </div>
            </div>
          </Section>
